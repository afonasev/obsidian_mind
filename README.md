...
│  ├─ store/               zustand-стор
│  └─ components/          UI (Canvas, CloudNode — появится в следующих change)
